...
install_splunk() {
  ...
  if [ -f "/opt/splunk/bin/splunk" ]; then
    ...
    /opt/splunk/bin/splunk add index opnsense -auth 'admin:changeme'
    
    #añadir index de opnsense
    ...
    /opt/splunk/bin/splunk install app /vagrant/resources/splunk_server/opnsense-app-for-splunk_112.tgz -auth 'admin:changeme'
    /opt/splunk/bin/splunk install app /vagrant/resources/splunk_server/opnsense-add-on-for-splunk_151.tgz -auth 'admin:changeme'
    

    #instalar add on para opnsense
